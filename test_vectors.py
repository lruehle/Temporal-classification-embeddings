...
model1 = load_model("aligned\cbow\\1600_cbow_align.model")
#model2 = load_model("models\\1700_word2vec.model")
model2 = load_model("aligned\cbow\\1700_cbow_align.model")
model3 = load_model("aligned\cbow\\1800_cbow_align.model")

# model_grimm = load_model("aligned\grimm\\1800_word2vec.model")
# model_skip_grimm = load_model("aligned\skip_grimm\\1800grimm_skip.model")
model_erw_1 = load_model("aligned\cbow_erw\\1600erw_cbow.model")
model_erw_2 = load_model("aligned\cbow_erw\\1700erw_cbow.model")
model_erw_3 = load_model("aligned\cbow_erw\\1800erw_cbow.model")
...
print("most similar in 1800 for: vector of 1600 for 'baum': ",model3.wv.most_similar(model1.wv["baum"],topn=3),"\n")  
print("most similar in 1700 for: vector of 1800 for 'baum': ",model2.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1600 for: vector of 1700 for 'baum': ",model1.wv.most_similar(model2.wv["baum"],topn=3),"\n")  
# print("most similar in 1800_grimm for: vector of 1800 for 'baum': ",model_grimm.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1800_erw for: vector of 1800 for 'frau': ",model_erw_3.wv.most_similar(model1.wv["frau"],topn=3),"\n")  
print("most similar in 1700_erw for: vector of 1700 for 'frau': ",model_erw_2.wv.most_similar(model1.wv["frau"],topn=3),"\n")  
print("most similar in 1600_erw for: vector of 1600 for 'frau': ",model_erw_1.wv.most_similar(model1.wv["frau"],topn=3),"\n")  
...
print("1700 most similar: pos 'koenig','frau', neg: 'mann': ",model2.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n") 
print("1800 most similar: pos 'koenig','frau', neg: 'mann': ",model3.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n") 

print("1600erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_1.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n") 
print("1700erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_2.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n") 
print("1800erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_3.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n") 

'''print("1600_erw most similar 'baum': ",model_erw_1.wv.most_similar("baum",topn=3),"\n")  
print("1700_erw most similar 'baum': ",model_erw_2.wv.most_similar("baum",topn=3),"\n")  
print("1800_erw most similar 'baum': ",model_erw_3.wv.most_similar("baum",topn=3),"\n")  
print("1800_grimm most similar 'baum': ",model_grimm.wv.most_similar("baum",topn=3),"\n")  
print("\n calculating concepts:\n")
print("1600 most similar: pos 'koenig','frau', neg: 'mann': ",model1.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n")  
print("1600_erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_1.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n")  
print("1700_erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_2.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n")  
print("1800_erw most similar: pos 'koenig','frau', neg: 'mann': ",model_erw_3.wv.most_similar(positive=['koenig', 'frau'], negative=['mann'],topn=3),"\n")  
...
'''print("erw_1800 vs _1800 ",model_erw_3.wv.most_similar(model3.wv["gott"],topn=3))
print("erw_1800 vs _1700 ",model_erw_3.wv.most_similar(model2.wv["gott"],topn=3))
print("erw_1800 vs _1600",model_erw_3.wv.most_similar(model1.wv["gott"],topn=3))
print("erw_1600vs _1800 ",model_erw_1.wv.most_similar(model3.wv["gott"],topn=3))
print("erw_1600vs _1700 ",model_erw_1.wv.most_similar(model2.wv["gott"],topn=3))
print("erw_1600vs _1600",model_erw_1.wv.most_similar(model1.wv["gott"],topn=3))
print("erw_1700 vs _1800 ",model_erw_2.wv.most_similar(model3.wv["gott"],topn=3))
print("erw_1700 vs _1700 ",model_erw_2.wv.most_similar(model2.wv["gott"],topn=3))
print("erw_1700 vs _1600",model_erw_2.wv.most_similar(model1.wv["gott"],topn=3))
...
print("vocab length 1600_erw Embeddings",len(model_erw_1.wv))
print("vocab length 1700_erw Embeddings",len(model_erw_2.wv))
print("vocab length 1800_erw Embeddings",len(model_erw_3.wv))
...
# print("1600_skip vector for 'baum'",model_skip_1.wv['gott'][:5])
# print("1700_skip vector for 'baum'",model_skip_2.wv['gott'][:5])
