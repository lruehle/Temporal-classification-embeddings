...
model2 = load_model("aligned\century\\1700_word2vec_aligned.model")
model3 = load_model("aligned\century\\1800_word2vec_aligned.model")
...
model_erw_1 = load_model("aligned\erw\\1600erw_word2vec.model")
model_erw_2 = load_model("aligned\erw\\1700erw_word2vec.model")
model_erw_3 = load_model("aligned\erw\\1800erw_word2vec.model")
...
print("most similar in 1800erw for: vector of 1800 for 'baum': ",model_erw_3.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1700erw for: vector of 1800 for 'baum': ",model_erw_2.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1600erw for: vector of 1800 for 'baum': ",model_erw_1.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1800_grimm for: vector of 1800 for 'baum': ",model_grimm.wv.most_similar(model3.wv["baum"],topn=3),"\n")  
print("most similar in 1800_erw for: vector of 1600 for 'frau': ",model_erw_3.wv.most_similar(model1.wv["frau"],topn=3),"\n")  
print("most similar in 1700_erw for: vector of 1600 for 'frau': ",model_erw_2.wv.most_similar(model1.wv["frau"],topn=3),"\n")  
